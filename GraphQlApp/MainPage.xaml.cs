...
namespace GraphQlApp
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            //var stringContent = new StringContent "{/ "query { user(login: kavyaarora) { bio, id, company, name, createdAt } }\"}"};
           ...
           // client.DefaultRequestHeaders.Add("User-Agent", "Graphql Api");
            ...
            //var stringContent = new StringContent("{\"query\":\"query {user(login: kavyaarora) { bio, id, company, name, createdAt } }\"}");
            ...
            GraphQLRequest graphQlRequest = new GraphQLRequest()
            {
                ...
                //Query = "query {user(login: kavyaarora) { bio,id,company,name,createdAt }}"
           Query =  "query{ allFilms{ films { id,title,director } }}"
            ...
            Console.WriteLine("Kavya " +films[0].Title);
